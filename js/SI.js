...
const n = 12;
const simpleInterest = (p, t, r, n) => {
    r = r / 100;
    const amount =[ p * (1 + r*t)]-p;
...
function updateAlldata() {
    ...
    for (var i = 1; i <= total_year; i++) {
        var yearly_interest = simpleInterest(invest_amount, i, interest_rate, 1);
        var yearly_rate = invest_amount + yearly_interest;

        var quaterly_interest = simpleInterest(
            invest_amount,
            i,
            interest_rate,
            3
        ...
        var monthly_interest = simpleInterest(
            invest_amount,
            i,
            interest_rate,
            12
        ...
        var daily_interest = simpleInterest(invest_amount, i, interest_rate, 365);
